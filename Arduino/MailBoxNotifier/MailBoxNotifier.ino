...
void setup() {
  ...
  Serial.begin(115200);
  Serial.print(F("MailBoxNotifier "));
   ...
   */
  PCintPort::attachInterrupt(pinILS1, interruptILS1, RISING);
  PCintPort::attachInterrupt(pinILS2, interruptILS2, RISING);

}

void presentation()  {
  sendSketchInfo("MailBoxNotifier over Sensebender Micro", RELEASE);
...
/*  if (sendBattery > 60) 
  ...
  Serial.print(F("comptageILS1="));
  Serial.print(comptageILS1);

  Serial.print(F(", comptageILS2="));
  Serial.println(comptageILS2);
